...
from plan2eplus.ops.schedules.interfaces.schedule_types import (
    UsefulScheduleTypeLimits,
)
from plan2eplus.ops.afn.defaults.wind_directions import wind_directions
from plan2eplus.ops.afn.defaults.pressure_coefficients import (
    north,
    south,
    east,
    west,
