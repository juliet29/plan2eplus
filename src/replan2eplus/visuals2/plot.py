...
class BasePlot:
    ...
    def plot_connections(
        ...
        # TODO, here want the possible and non possible..
        ...
        # iterating through a named tuple?
        # for item, spec_style in zip(connections_org, style):
        #     add_connection_lines(
        #         [i.domain for i in item],
        #         [i.edge for i in item],
        #         self.zones,
        #         self.cardinal_domain.cardinal,
        #         spec_style,
        #         self.axes,
